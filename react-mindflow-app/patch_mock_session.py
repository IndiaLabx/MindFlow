...
content = content.replace("import { useMockTimer } from '../hooks/useMockTimer';", "import { useMockSessionTimer } from '../hooks/useMockSessionTimer';")
...
new_hook = """const { timeLeft, formatTime, getAndResetCurrentQuestionTime, getCurrentQuestionTimeRef } = useMockSessionTimer({
