...
export const MobileDemoCard: React.FC = () => {
  return (
    ...
    >
      <div className="relative w-full h-full bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl rounded-[2rem] p-6 sm:p-8 overflow-hidden flex flex-col border border-white/20 dark:border-slate-800/50">
        {/* Glossy Shine */}
        ...
        <div className="relative z-10 flex-1 flex flex-col">
            ...
            <div className="space-y-2.5 flex-1">
              ...
              <div className="p-3 rounded-xl border border-white/60 dark:border-slate-700/50 bg-white/60 dark:bg-slate-800/60 flex items-center gap-3 opacity-80">
