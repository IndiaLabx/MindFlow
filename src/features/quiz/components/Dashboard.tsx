      ...
      <div className="flex-1 flex flex-col space-y-6 py-4 relative z-10 animate-fade-in w-full">
        ...
        >
          ...
          >
            ...
            <div
              className={`relative z-20 flex flex-col items-center justify-between h-full w-full p-4 sm:p-6 transition-opacity duration-300 ${loadingId === "card-mcqs" ? "opacity-0" : "opacity-100"}`}
            >
              {/* SVG Container */}
              <motion.div
              ...
              <div className="flex flex-col items-center justify-end w-full text-center pb-2">
                <div className="flex items-center justify-center mb-1 sm:mb-2 gap-1">
                  <h3 className="text-sm sm:text-lg font-black leading-tight bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-600 to-fuchsia-900 dark:from-fuchsia-300 dark:to-fuchsia-100">
                    MCQs Quiz
                  </h3>
