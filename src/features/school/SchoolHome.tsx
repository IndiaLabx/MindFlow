                    ...
                    >
                        ...
                        <div className="relative z-20 flex flex-col items-center justify-center h-full w-full p-4 sm:p-6">
                            ...
                            <div className="flex flex-col items-center justify-end w-full text-center">
                                <h3 className="text-xl sm:text-2xl font-black leading-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-600 to-cyan-900 dark:from-cyan-300 dark:to-cyan-100 mb-2">Download Center</h3>
