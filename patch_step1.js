...
// Add motion and useEffect imports
...
const wrapperRegex = /<div className="flex flex-col">/g;
const newWrapper = `<div className="flex flex-col min-h-screen -m-4 sm:-m-6 lg:-m-8 p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-white dark:from-slate-950 dark:via-indigo-950/20 dark:to-slate-900 animate-flow transition-colors duration-700">`;
